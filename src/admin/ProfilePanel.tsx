    ...
    <form onSubmit={save}>
      ...
      <div className="field">
        ...
        <select value={homeLayout} onChange={(e) => setHomeLayout(e.target.value)}>
          ...
          <option value="grid-5">5 columns (dense)</option>
          <option value="tiles-xl">Tiles XL (2 big)</option>
          <option value="gallery">Gallery (cover mosaic)</option>
          <option value="zigzag">Zigzag (alternating rows)</option>
          <option value="cover-list">Cover list (thumb + text)</option>
          <option value="numbered">Numbered list</option>
          <option value="polaroid">Polaroid (tilted cards)</option>
          <option value="mosaic">Mosaic (feature-first)</option>
          <option value="stack">Stack (full-width banners)</option>
          <option value="index">Index (minimal table)</option>
          <option value="spotlight">Spotlight (hero + grid)</option>
